...
public class UserController {
    ...
    @Operation(summary = "Login by eamil and passowrd", description = "API to login user in the system by id")
    @PatchMapping("/login")
    public ResponseEntity<?> login(@RequestParam String email, @RequestParam String password) {

        userService.login(email, password);

        return new ResponseEntity<>("Welcome to the system", HttpStatus.OK);
